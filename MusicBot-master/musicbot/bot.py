...
class MusicBot(discord.Client):
    ...
    async def cmd_play(self, player, channel, author, permissions, leftover_args, song_url):
        ...
        if 'entries' in info:
            ...
            reply_text = ":gear: Song has been selected **%s** **#%s**"
    ...
    async def _cmd_play_playlist_async(self, player, channel, author, permissions, playlist_url, extractor_type):
        ...
        return Response(":gear: Enqueued {} songs to be played in {} seconds".format(
    ...
    async def cmd_search(self, player, channel, author, permissions, leftover_args):
        ...
        search_msg = await self.send_message(channel, "**Okay, Please Wait While Bot Searching for your song...**")
        await self.send_typing(channel)
        ...
        if not info:
            return Response("**I Can't Find Your Result**.", delete_after=30)
        ...
        for e in info['entries']:
            ...
            if response_message.content.lower().startswith('y'):
                ...
                return Response("Alright,Now Playing Your Song", delete_after=30)
            else:
                await self.safe_delete_message(result_message)
                await self.safe_delete_message(confirm_message)
                await self.safe_delete_message(response_message)
    ...
    async def cmd_now(self, player, channel, server, message):
        """
        Usage:
            {command_prefix}np
    ...
    async def cmd_stop(self, server):
        ...
        return Response("**The queue has been emptied,The track has been removed.**", delete_after=20)
